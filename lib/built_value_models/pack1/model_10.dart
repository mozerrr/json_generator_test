...
abstract class Model10 implements Built<Model10, Model10Builder> {
  Model10._();

  factory Model10([Function(Model10Builder b) updates]) = _$Model10;

  static Serializer<Model10> get serializer => _$model10Serializer;
